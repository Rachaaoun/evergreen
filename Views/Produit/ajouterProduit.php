          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row tm-edit-product-row">
              <div class="col-xl-12 col-lg-12 col-lg-12">
                <form action="" class="tm-edit-product-form" method="POST">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <textarea type="text" name="prix" id="prix" maxlength="20"  class="form-control validate"></textarea>
              ...
              <div class="col-12">
                ...
                <input type="submit" href="afficherProduitB.php"class="btn btn-primary btn-block text-uppercase" value="Add Product Now" ></input>
